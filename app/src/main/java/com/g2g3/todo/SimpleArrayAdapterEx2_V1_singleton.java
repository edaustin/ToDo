...
public class SimpleArrayAdapterEx2_V1_singleton extends ArrayAdapter<String>{
	...
	public SimpleArrayAdapterEx2_V1_singleton(Context context, ArrayList<String> values) {
