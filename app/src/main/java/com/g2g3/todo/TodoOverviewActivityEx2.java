...
public class TodoOverviewActivityEx2 extends ListActivity {
    ...
    private void createTodo() {
        ...
        //startActivityForResult(new Intent(this, TodoDetailsActivityEx2.class), RQ);
        startActivity(new Intent(this, TodoDetailsActivityEx2.class));
